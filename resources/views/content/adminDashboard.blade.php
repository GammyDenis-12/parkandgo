                            ...
                            <div class="tab-content p-0">
                                ...
                                <div class="chart tab-pane active" id="revenue-chart"
                                    ...
                                    <canvas id="revenue-chart-canvas" height="600"
                                        style="height: 300px; display: block; width: 657px;" width="1314"
                    ...
                    <div class="card bg-gradient-primary">
                        ...
                        <div class="card-body">
                            <div id="world-map"
                                ...
                                <svg width="453.5" height="250">
                                    <g transform="scale(0.421585160202361) translate(58.350999999999885, 0)">
                                        <path
                    ...
                    <div class="card bg-gradient-info">
                        ...
                        <div class="card-body">
                            ...
                            <canvas class="chart chartjs-render-monitor" id="line-chart"
                                style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%; display: block; width: 454px;"
                                width="908" height="500"></canvas>
                        </div>
